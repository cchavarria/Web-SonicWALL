...
function init() {
	...
	$(document).ready(function () {
		...
		getLocalizedContent([/*'EventLabelEventType', 'EventLabelDate', 'LabelAllEvents',
			'EventLabelRecordedDate', 'EventLabelLocation', 'EventLabelAllDates', 'LabelAllProducts',*/
			'LabelAllProductLines', 'LabelAllSolutions'/*, 'LabelAllLanguages', 'LabelAllCountries', 'LabelAllStates'*/]).done(function () {
