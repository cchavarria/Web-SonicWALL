...
getLocalizedContent("LabelBack").done(function (data) {
	$('.site-wrapper').after('<div id="off-canvas" class="hidden"><div class="bg-grey border-b-gray p-10"><a class="off-canvas-back"><i class="glyphicon glyphicon-menu-left"></i><span>' + data.LabelBack + '</span></a></div><div class="off-canvas-content"></div></div>');
